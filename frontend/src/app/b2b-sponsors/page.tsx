...
export default function SponsorsInfo() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden text-foreground">
      ...
      <main className="relative z-10 pt-10 sm:pt-20 pb-16 sm:pb-24 px-4 sm:px-6 max-w-4xl mx-auto">
        <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="text-center mb-8 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter mb-4 sm:mb-6 text-white">
            For Sponsors
          </h1>
        ...
        <motion.div
          ...
          className="glass-card rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-8 md:p-12 border border-white/5 shadow-2xl"
        >
          ...
          <div className="mt-8 sm:mt-12 pt-8 sm:pt-12 border-t border-white/10 text-center flex flex-col items-center gap-4">
            <h3 className="text-xl sm:text-2xl font-bold">Launch Your Program Today</h3>
            <button className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-primary text-background rounded-2xl font-black uppercase tracking-widest text-xs sm:text-sm flex items-center justify-center gap-2 hover:scale-105 transition-all shadow-xl shadow-primary/20">
              Contact Enterprise Team <span>09121569058</span> <ChevronRight className="w-4 h-4" />
            </button>
          </div>
        </motion.div>
      </main>
